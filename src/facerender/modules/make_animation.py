...
def make_animation(source_image, source_semantics, target_semantics,
                            generator, kp_detector, he_estimator, mapping, frame_num,
    ...
    with torch.no_grad():
        ...
        source_num = len(kp_canonical)
        print("kp_canonical_num: ", len(kp_canonical))
        ...
        for frame_idx in tqdm(range(target_semantics.shape[1]), 'Face Renderer:'):
            ...
            if frame_idx > source_num - 1:
                ind = frame_idx % source_num
                print(ind)
                kp_canonical_i = kp_canonical[ind]
                kp_source_i = kp_source[ind]
                source_image_i = source_image[ind]
            else:
                kp_canonical_i = kp_canonical[frame_idx]
                kp_source_i = kp_source[frame_idx]
                source_image_i = source_image[frame_idx]
            ...
            kp_driving = keypoint_transformation(kp_canonical_i, he_driving)
                
            #kp_norm = normalize_kp(kp_source=kp_source, kp_driving=kp_driving,
                                   #kp_driving_initial=kp_driving_initial)
            kp_norm = kp_driving
            out = generator(source_image_i, kp_source=kp_source_i, kp_driving=kp_norm)
            '''
